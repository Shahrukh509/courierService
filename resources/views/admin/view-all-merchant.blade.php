...
<td>{{ $data->region }}</td>
<td>{{ $data->status}}</td>
<td><a class="btn btn-primary" href="{{ route('edit.merchant',$data->id) }}">edit</a><a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data')" href="{{ route('delete.merchant',$data->id) }}">delete</a></td>
</tr>
</tbody>    
@endforeach()
</table>
