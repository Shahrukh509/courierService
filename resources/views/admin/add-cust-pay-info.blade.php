    ...
    <div class="container float-center">
        ...
        <div class="row mt-4">
            <div class="col-12 col-md-12">
                <div class="row">
            <form action="{{ route('add_customer_pay_info') }}" method="Post">
                @csrf
                     
                    <div class="col-12  pt-2">
                         <label for="points">Payment Type</label>
                        <input type="text" id="points" name="type">
                    </div>


                      <div class="col-12  pt-2">
                         <label for="points">Description</label>
                        <input type="text" id="points" name="description">
                    </div>

                      <div class="col-12  pt-2">
                         <label for="points">Business Name</label>
                        <input type="text" id="points" name="business_name">
                    </div>

                   
                      <div class="col-12  pt-2">
                         <label for="points">Mobile Number</label>
                        <input type="tel" id="points" name="mobile">
                    </div>

                     <div class="col-12  pt-2">
                         <label for="points">Amount</label>
                        <input type="number" id="points" name="amount">
                    </div>
                    <div class="col-12  pt-2">
