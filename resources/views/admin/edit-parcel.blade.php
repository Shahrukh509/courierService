            ...
            <form action="{{ route('update_parcel',$data->id) }}" method="Post">
                @csrf
                     ...
                     <div class="col-12  pt-2">
                         <label for="points">Parcel Amount with delivery charges</label>
                        <input type="number" id="points" name="amount" value="{{ $data->amount }}">
                    </div>
                      
                    <div class="col-12  pt-2">
                         <label for="points">Choose Merchant</label>
                        <select style="height: 36px;" class="custom-field" name="user_id" id="">
                    ...
                    <div class="col-12  pt-2">
                        ...
                        <input type="text" id="points" name="note" value="{{ $data->note }}">
                    </div>

                    <div class="col-12  pt-2">
                         <label for="points">Status</label>
                        <select name = "status">
