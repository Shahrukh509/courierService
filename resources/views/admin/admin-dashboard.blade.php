                        ...
                        <div class="col-12 col-md-3 my-3">
                            <div class="white-div">
                                <div class="row">
                                    <div class="col-3">
                                        <span>
                                           <img src="{{asset('ekhone/images/avatar6.PNG')}}" style="margin-top: 10px;width:30px;height:30px;border-radius:50px;" alt="">
                                        </span>
                                    </div>
                                    <div class="col-9 text-right font-weight-bold">
                                        Total Merchant <br>
                ...
                <div class="w-100 d-flex">
                    <div class="w-100 px-4" id="dashMenu">
                        <div class="list-group side-menu-list mb-ovr-scl">
                            <a href="{{route('add_delivery_boy')}}" class="list-group-item text-capitalize list-group-item-action">Add Delivery Boy</a>
                            <a href="{{route('add_delivery_boy')}}" class="list-group-item text-capitalize list-group-item-action">Delivery Boy Expenses</a>
                            <a href="{{route('tracking_parcel')}}" class="list-group-item text-capitalize list-group-item-action">Tracking Parcel</a>
                            <a href="{{route('view_all_parcel')}}" class="list-group-item text-capitalize list-group-item-action">View All Parcel</a>
                            ...
                            <a href="{{route('view_all_merchant')}}" class="list-group-item text-capitalize list-group-item-action">View All Merchant</a>
                            
                            <a href="#" class="list-group-item text-capitalize list-group-item-action">Office Detail</a>
                    ...
                    <ul class="list-style-none mbl-menu-list d-flex p-0 m-0">
                        ...
                        <li class="text-center without-focus px-1">
                            <a  href = "{{route('add_delivery_boy')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Add Boy</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href = "{{route('add_delivery_boy')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Boy Expenses</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href="{{route('add_parcel')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Parcels</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href="{{route('tracking_parcel')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Tracking</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href="{{route('view_payment')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Payments</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href="{{route('setting')}}" class="without-focus">
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">Merchants</p>
                            </a>
                        </li>
                        <li class="text-center without-focus px-1">
                            <a href="" class="without-focus">
                                ...
                                <p class="text-center font-13 text-color-3 mt-2 mb-0">Office Expenses</p>
                            </a>
                        </li>
