                                    ...
                                    <div class="w-100 bg-white rounded p-4">
                                        ...
                                        <div class="tab">
                                            <button class="tablinks" onclick="openCity(event, 'London')"
                                                id="defaultOpen">Company Information</button>
                                            <button class="tablinks" onclick="openCity(event, 'Paris')">Owner
                                                Information</button>
                                            <button class="tablinks" onclick="openCity(event, 'Tokyo')">Pickup
                                                Method</button>
                                            <button class="tablinks" onclick="openCity(event, 'payment')">Payment
                                                Method</button>
                                            <button class="tablinks" onclick="openCity(event, 'bank')">Bank
                                                Account</button><button class="tablinks"
                                                onclick="openCity(event, 'others')">Other Account</button>
                                        </div>

                                        <div id="London" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="com-info" role="tabpanel" aria-labelledby="com-info-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Business Information</h6>
                                                <div>
                                                    <div class="form-group row"><label for="CoName"
                                                            class="col-xl-2 col-lg-3 col-md-4 text-color-5 font-15 col-form-label">Company
                                                            Name</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                                            <p class="mb-0"><strong>Lorem Ipsum</strong></p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div
                                                            class="offset-xl-2 offset-lg-3 offset-md-4 col-xl-4 col-lg-5 col-md-8 pt-4">
                                                            <button
                                                                class="btn btn-block bg-color-seagreen text-white shadow-1">Update</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="Paris" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="own-info" role="tabpanel" aria-labelledby="own-info-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Owner Information</h6>
                                                <div>
                                                    <div class="form-group row"><label for="ownName"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Name</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                                            <p class="mb-0"><strong>Bilal Arshad</strong></p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="mobileNo"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Mobile
                                                            Number</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="mobileNo" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="email-2"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Email</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                                            <p class="mb-0">bilalarshad489@gmail.com</p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div
                                        ...
                                        <div id="Tokyo" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="pick-method" role="tabpanel" aria-labelledby="pick-method-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Pickup Methods</h6>
                                                <div>
                                                    <div class="form-group row"><label for="Pick-Addr"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Pickup
                                                            Address</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><textarea id="Pick-Addr"
                                                                rows="3"
                                                                class="form-control font-15 text-color-5"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="neareZone"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Nearest
                                                            Zone</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select
                                                                id="neareZone"
                                                                class="form-control font-15 text-color-5">
                                                                <option value="10">Badda</option>
                                                                <option value="22">Banani</option>
                                                                <option value="36">Barishal</option>
                                                                <option value="21">Bashundhara</option>
                                                                <option value="41">bogura</option>
                                                                <option value="49">Brahmanbaria</option>
                                                                <option value="50">Chadpur</option>
                                                                <option value="31">Chittagong</option>
                                                                <option value="37">Comilla</option>
                                                                <option value="26">Dhaka-Cant</option>
                                                                <option value="3">Dhanmondi</option>
                                                                <option value="42">Dinajpur</option>
                                                                <option value="20">Farmgate</option>
                                                                <option value="52">Feni</option>
                                                                <option value="29">Gazipur</option>
                                                                <option value="9">Gulshan</option>
                                                                <option value="6">Jattrabari</option>
                                                                <option value="33">Jessore</option>
                                                                <option value="14">Keraniganj</option>
                                                                <option value="7">Khilgaon</option>
                                                                <option value="34">khulna</option>
                                                                <option value="44">kishoregonj</option>
                                                                <option value="11">Mirpur</option>
                                                                <option value="24">Mirpur-1</option>
                                                                <option value="25">Mirpur-Pallabi</option>
                                                                <option value="27">Mirpur10</option>
                                                                <option value="28">Mirpur60Ft</option>
                                                                <option value="16">Mogbazar</option>
                                                                <option value="13">Mohakhali</option>
                                                                <option value="2">Mohammadpur</option>
                                                                <option value="4">Motijheel</option>
                                                                <option value="43">Munshigonj</option>
                                                                <option value="35">mymensing</option>
                                                                <option value="15">Narayanganj</option>
                                                                <option value="40">Narsingdi</option>
                                                                <option value="47">NIKUNJO</option>
                                                                <option value="45">Noakhali</option>
                                                                <option value="1">Not Assigned</option>
                                                                <option value="5">Old Dhaka</option>
                                                                <option value="48">Patuakhali</option>
                                                                <option value="38">Rajshahi</option>
                                                                <option value="23">Rampura</option>
                                                                <option value="30">Rangpur</option>
                                                                <option value="18">SA_Paribahan</option>
                                                                <option value="12">Savar</option>
                                                                <option value="19">Shahbag</option>
                                                                <option value="51">Sirajganj</option>
                                                                <option value="17">Sundorban</option>
                                                                <option value="32">sylhet</option>
                                                                <option value="46">Tangail</option>
                                                                <option value="39">Tejgaon</option>
                                                                <option value="8">Uttara</option>
                                                            </select></div>
                                                    </div>
                                                    <div class="form-group row"><label for="pickPrefer"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Pickup
                                                            Preference</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select
                                                                id="pickPrefer"
                                                                class="form-control font-15 text-color-5">
                                                                <option value="0">As Per Request</option>
                                        ...
                                        <div id="payment" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="pay-method" role="tabpanel" aria-labelledby="pay-method-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Payment Methods</h6>
                                                <div>
                                                    <div class="form-group row"><label for="dePayment"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Default
                                                            Payment</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select
                                                                id="dePayment"
                                                                class="form-control font-15 text-color-5">
                                                    ...
                                                    <div class="form-group row"><label for="withdrawal"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Withdrawal</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select
                                                                id="withdrawal"
                                                                class="form-control font-15 text-color-5">
                                                                <option value="0">As per Request</option>
                                        ...
                                        <div id="bank" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="bank-ac" role="tabpanel" aria-labelledby="bank-ac-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Bank Account</h6>
                                                <div>
                                                    <div class="form-group row"><label for="bnName"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Name
                                                            of Bank</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="bnName" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="bnBranch"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Branch</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="bnBranch" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="ac-holder"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">A/C
                                                            Holder Name</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="ac-holder"
                                                                class="form-control font-15 text-color-5"></div>
                                                    </div>
                                                    <div class="form-group row"><label for="ac-No"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Bank
                                                            A/C No.</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="ac-No" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div
                                        ...
                                        <div id="others" class="tabcontent">
                                            <span onclick="this.parentElement.style.display='none'"
                                                class="topright">&times</span>
                                            <div id="other-ac" role="tabpanel" aria-labelledby="other-ac-tab"
                                                class="tab-pane fade active show">
                                                <h6 class="text-color-5 font-15 mb-4">Other Account</h6>
                                                <div>
                                                    <div class="form-group row"><label for="bkash"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Bkash</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="bkash" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label for="rocket"
                                                            class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Rocket</label>
                                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text"
                                                                id="rocket" class="form-control font-15 text-color-5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div
            ...
            <div class="row py-2 mb-4">
                <div class="w-100 bg-white my-4">
                    <div class="w-100 bg-white rounded p-4">
                        ...
                        <div class="tab">
                            <button class="tablinks active" onclick="openCity(event, 'Londonn')" id="defaultOpen">Company Information</button>
                            <button class="tablinks" onclick="openCity(event, 'Pariss')">Owner
                                Information</button>
                            <button class="tablinks" onclick="openCity(event, 'Tokyoo')">Pickup
                                Method</button>
                            <button class="tablinks" onclick="openCity(event, 'paymentt')">Payment
                                Method</button>
                            <button class="tablinks" onclick="openCity(event, 'bankk')">Bank
                                Account</button><button class="tablinks" onclick="openCity(event, 'otherss')">Other Account</button>
                        </div>

                        <div id="Londonn" class="tabcontent" style="display: block;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="com-info" role="tabpanel" aria-labelledby="com-info-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Business Information</h6>
                                <div>
                                    <div class="form-group row"><label for="CoName" class="col-xl-2 col-lg-3 col-md-4 text-color-5 font-15 col-form-label">Company
                                            Name</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                            <p class="mb-0"><strong>Lorem Ipsum</strong></p>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-xl-2 offset-lg-3 offset-md-4 col-xl-4 col-lg-5 col-md-8 pt-4">
                                            <button class="btn btn-block bg-color-seagreen text-white shadow-1">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="Pariss" class="tabcontent" style="display: none;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="own-info" role="tabpanel" aria-labelledby="own-info-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Owner Information</h6>
                                <div>
                                    <div class="form-group row"><label for="ownName" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Name</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                            <p class="mb-0"><strong>Bilal Arshad</strong></p>
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="mobileNo" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Mobile
                                            Number</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="mobileNo" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="email-2" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Email</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8">
                                            <p class="mb-0">bilalarshad489@gmail.com</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-xl-2 offset-lg-3 offset-md-4 col-xl-4 col-lg-5 col-md-8 pt-4">
                                            <button type="button" class="btn btn-block bg-color-seagreen text-white shadow-1">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="Tokyoo" class="tabcontent" style="display: none;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="pick-method" role="tabpanel" aria-labelledby="pick-method-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Pickup Methods</h6>
                                <div>
                                    <div class="form-group row"><label for="Pick-Addr" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Pickup
                                            Address</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><textarea id="Pick-Addr" rows="3" class="form-control font-15 text-color-5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="neareZone" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Nearest
                                            Zone</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select id="neareZone" class="form-control font-15 text-color-5">
                                                <option value="10">Badda</option>
                                                <option value="22">Banani</option>
                                                <option value="36">Barishal</option>
                                                <option value="21">Bashundhara</option>
                                    ...
                                    <div class="form-group row"><label for="pickPrefer" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Pickup
                                            Preference</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select id="pickPrefer" class="form-control font-15 text-color-5">
                                                <option value="0">As Per Request</option>
                                                <option value="1">Daily</option>
                                            </select></div>
                                    </div>
                        ...
                        <div id="paymentt" class="tabcontent" style="display: none;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="pay-method" role="tabpanel" aria-labelledby="pay-method-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Payment Methods</h6>
                                <div>
                                    <div class="form-group row"><label for="dePayment" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Default
                                            Payment</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select id="dePayment" class="form-control font-15 text-color-5">
                                                <option value="1">Bank</option>
                                                <option value="2">bKash</option>
                                                <option value="3">Rocket</option>
                                                <option value="0">Cash</option>
                                    ...
                                    <div class="form-group row"><label for="withdrawal" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Withdrawal</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8 cs-drop-arrow"><select id="withdrawal" class="form-control font-15 text-color-5">
                                                <option value="0">As per Request</option>
                                                <option value="1">Daily</option>
                                                <option value="2">Weekly</option>
                                            </select></div>
                        ...
                        <div id="bankk" class="tabcontent" style="display: none;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="bank-ac" role="tabpanel" aria-labelledby="bank-ac-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Bank Account</h6>
                                <div>
                                    <div class="form-group row"><label for="bnName" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Name
                                            of Bank</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="bnName" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="bnBranch" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Branch</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="bnBranch" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="ac-holder" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">A/C
                                            Holder Name</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="ac-holder" class="form-control font-15 text-color-5"></div>
                                    </div>
                                    <div class="form-group row"><label for="ac-No" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Bank
                                            A/C No.</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="ac-No" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-xl-2 offset-lg-3 offset-md-4 col-xl-4 col-lg-5 col-md-8 pt-4">
                        ...
                        <div id="otherss" class="tabcontent" style="display: none;">
                            <span onclick="this.parentElement.style.display='none'" class="topright">×</span>
                            <div id="other-ac" role="tabpanel" aria-labelledby="other-ac-tab" class="tab-pane fade active show">
                                <h6 class="text-color-5 font-15 mb-4">Other Account</h6>
                                <div>
                                    <div class="form-group row"><label for="bkash" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Bkash</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="bkash" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label for="rocket" class="col-xl-2 col-lg-3 col-md-4 font-15 text-color-5 col-form-label">Rocket</label>
                                        <div class="col-xl-4 col-lg-5 col-md-8"><input type="text" id="rocket" class="form-control font-15 text-color-5">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-xl-2 offset-lg-3 offset-md-4 col-xl-4 col-lg-5 col-md-8 pt-4">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card info-card border-0 my-3 cursor-pointer" data-toggle="modal"
                                        data-target="#pickupModal" @click="resetNDPickUp">
                                ...
                                <div class="col-6">
                                    <div class="card info-card border-0 my-3 cursor-pointer" data-toggle="modal"
                                        data-target="#SDpickupModal" @click="resetSDPickUp">
                                        <div class="card-body rounded">
                                            <div class="text-center over-badge">
