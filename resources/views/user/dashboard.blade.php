...
<head>
    ...
    <title>Merchant Dashboard | Ekhone</title>
                ...
                <div class="col-md-10 ml-auto bg-color-1">
                    ...
                    <div class="row bg-white sticky-top shadow-sm">
                        <div class="w-100 top-nav-dash px-xl-4 px-md-2 mx-sm-3">
                            ...
                            {{-- Notification TOPNavMenu (Website) --}}
                    ...
                    <div class="row p-xl-3 p-md-2 my-3">
                        ...
                        <!-- Top Cards Info Dashboard (Website) -->
                        ...
                        <!-- Below Cards Info Dashboard (Website) -->
                        <div class="col-12">
                            <h5> All Reports </h5>
        ...
        <div class="col-12 bg-white d-md-none d-block">
                ...
                <div class="w-100 d-flex">
                    <div class="w-100 px-4" id="dashMenu">
                        <div class="list-group side-menu-list mb-ovr-scl">
                            ...
                            <a href="{{route('view_parcel')}}" class="list-group-item text-capitalize list-group-item-action">View Parcel</a> 
            ...
            <div class="row">
                <div class="col-12 py-2">
                    <ul class="list-style-none mbl-menu-list d-flex text-center">
                        {{-- Add Parcel (Mobile) --}}
                        <li class="text-center without-focus px-1">
                         ...
                         {{-- View Parcel (Mobile) --}}
                        <li class="text-center without-focus px-1">
                            <a href="{{route('view_parcel')}}" class="without-focus">
                                <div class="menu-list">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="34" viewBox="0 -15 366 366"
                                        width="36">
                                        <path d="m40 276.523438h46v20h-46zm0 0" fill="#ffffff"></path>
                                ...
                                <p class="text-center font-12 text-color-3 mt-2 mb-0">View Parcel</p>
                            </a>
                        </li>
                         {{-- Tracking Parcel (Mobile) --}}
                        <li class="text-center without-focus px-1">
